...
export default function Portfolio({
  ...
  tf, setTf, tradeMode, setTradeMode, tradeAmt, setTradeAmt, trade, active, history, startCash, deposited, vhistory, depCadence, depTime, depAmount, gameStart,
  ...
  const { points: perfPoints, chg: perfChg, pct: perfPct, up: perfUp, label: perfLabel, resolution: perfRes } = usePortfolioPerf(positions, cash, startCash, totalValue, perfTf, history, gameStart, "own", deposited, vhistory, depCadence, depTime, depAmount);
